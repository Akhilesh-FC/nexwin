...
<div class="register-card position-relative">
    ...
    <form method="POST" action="<?php echo e(route('demo_register.store')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/Newprojectadmin.codescarts.com/resources/views/user/demo_user.blade.php ENDPATH**/ ?>