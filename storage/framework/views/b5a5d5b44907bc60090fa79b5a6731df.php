...
?>
        ...
        <!--                <?php endif; ?>-->
         ...
         <?php if(in_array('fund_transfer', $allowed)): ?> 
                     <li><a href="<?php echo e(route('fund_transfer')); ?>"><i class="fa fa-user orange_color"></i> <span>Fund transfer</span></a></li>
					  <?php endif; ?>
        
         <?php if(in_array('illegalUsers', $allowed)): ?> 
                     <li><a href="<?php echo e(route('admin.illegalUsers')); ?>"><i class="fa fa-user orange_color"></i> <span>Illegal Users</span></a></li>
					  <?php endif; ?>
          
          
          <?php if(in_array('System_User', $allowed)): ?> 
                     <li><a href="<?php echo e(route('register.create')); ?>"><i class="fa fa-user orange_color"></i> <span>System User</span></a></li>
					  <?php endif; ?>
          
          
           <?php if(in_array('ip_address', $allowed)): ?> 
                     <li><a href="<?php echo e(route('ip_address')); ?>"><i class="fa fa-user orange_color"></i> <span>IP address</span></a></li>
					  <?php endif; ?>
  
  
            
					   <?php if(in_array('otp_history', $allowed)): ?> 
                     <li><a href="<?php echo e(route('otp_history')); ?>"> <i class="fa fa-history"></i> <span>OTP Pack History</span></a></li>
					  <?php endif; ?>
       ...
       <!--               <?php if(in_array('deposit', $allowed)): ?>-->
					  <!-- <li>-->
       <!--                  <a href="#app13" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-tasks  green_color"></i>            <span>Indian Pay Deposit</span></a>-->
       ...
       <!--             	 <?php if(in_array('widthdrawl', $allowed)): ?>				  -->
					  <!--<li>-->
       <!--                  <a href="#app11" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-wrench purple_color2"></i>            <span>Indian Pay Withdrawal</span></a>-->
       ...
       <!--               <?php endif; ?>-->
            ...
            <!-- end sidebar --><?php /**PATH /www/wwwroot/Newprojectadmin.codescarts.com/resources/views/admin/body/sidebar.blade.php ENDPATH**/ ?>