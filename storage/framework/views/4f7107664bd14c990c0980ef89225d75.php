...
<script>
    $(document).ready(function () {
        $('#ipTable').DataTable({
            ...
            searching: true,
            ordering: true,
            order: [], // 👈 Keep Laravel's original sequence
            language: {
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/Newprojectadmin.codescarts.com/resources/views/login_user_ip_detail/index.blade.php ENDPATH**/ ?>