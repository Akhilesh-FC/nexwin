...
<div class="container-fluid py-5">
  ...
  <div class="current-timer-container">
    <div class="timer-label" id="current-timer-label">
      <?php if($gameid == 1): ?>
       Wingo 30 SECOND GAME COUNTDOWN
      <?php elseif($gameid == 2): ?>
       Wingo 1 MINUTE GAME COUNTDOWN
      <?php elseif($gameid == 3): ?>
       Wingo 3 MINUTE GAME COUNTDOWN
      <?php elseif($gameid == 4): ?>
       Wingo 5 MINUTE GAME COUNTDOWN
      <?php endif; ?>
    </div>
    ...
    <div class="timer-game-info">
      <!--<span>Period: <strong id="current-period"><?php echo e($bets[0]->games_no ?? '--'); ?></strong></span>-->
      <!--<span>Game ID: <?php echo e($gameid); ?></span>-->
    </div>
  </div>
        ...
        <?php $__currentLoopData = $bets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="result-wrapper">
            <div class="data-count" data-number="<?php echo e($key); ?>" data-gameid="<?php echo e($gameid); ?>">
              <img src="https://root.bdgcassino.com/wingo/<?php echo e($key); ?>.png" alt="<?php echo e($key); ?>">
            </div>
          ...
          <select name="number" class="form-select rounded-pill" required>
            ...
            <?php for($i=0;$i<=9;$i++): ?>
              <option value="<?php echo e($i); ?>"><?php echo e($i); ?> - 
                <?php if($i == 0 || $i == 5): ?>
                  Violet
                <?php elseif(in_array($i, [1, 3, 7, 9])): ?>
                  Red
                <?php else: ?>
                  Green
                <?php endif; ?>
                (<?php echo e($i >= 5 ? 'Big' : 'Small'); ?>)
              </option>
            <?php endfor; ?>
          </select>
        </div>
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/Newprojectadmin.codescarts.com/resources/views/colour_prediction/index.blade.php ENDPATH**/ ?>