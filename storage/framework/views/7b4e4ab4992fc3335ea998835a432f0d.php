                     ...
                     <tr>
                       ...
                       <td>
                        ...
                        <td>
                           ...
                           <!-- DELETE BUTTON -->
                           <a href="<?php echo e(route('gift.delete',$item->id)); ?>"
    ...
    <div class="modal-body">
     <div class="row">
      ...
      <div class="form-group col-md-6">
        ...
        class="form-control"
        value="<?php echo e($item->expire_date); ?>">
      </div>
      ...
      <div class="form-group col-md-6">
        ...
        <select name="type" class="form-control">
          ...
          <option value="1"
          <?php echo e($item->type==1?'selected':''); ?>>Loss</option>

          <option value="2"
          <?php echo e($item->type==2?'selected':''); ?>>Win</option>
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/root.nexwin.vip/resources/views/gift/index.blade.php ENDPATH**/ ?>