...
integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
 ...
 <form style="margin-top:200px;" method="post" action="<?php echo e(route('notification.update',$views->id)); ?>">
   <?php echo csrf_field(); ?>
 
     <input type="hidden" name="id" value="<?php echo e($views->id); ?>" >
     
     <textarea class="form-control" id="editor" name="disc">
         <?php echo e($views->disc); ?>
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/root.nexwin.vip/resources/views/work_order_assign/view_notification.blade.php ENDPATH**/ ?>