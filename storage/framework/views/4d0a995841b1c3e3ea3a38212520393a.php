...
<td><?php echo e($item->ifsc_code ?? '-'); ?></td>
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <!--<a href="<?php echo e(route('manual_widthdrawl.reject',$item->id)); ?>">Reject</a>-->
      
      <form action="<?php echo e(route('manual_widthdrawl.reject', $item->id)); ?>" method="POST" style="display:inline;">
    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="exampleModalCenter3<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('manual_widthdrawl.success', ['id' => $item->id])); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/root.nexwin.vip/resources/views/manual_withdraw/index.blade.php ENDPATH**/ ?>