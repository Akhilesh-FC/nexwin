...
<div class="card shadow mb-4">
  <div class="card-header bg-success text-white">
    <h4 class="mb-0">Signup Contact Support</h4>
  </div>
  ...
  <div class="card-body">
    ...
    <?php echo e($signup_contact_support->longtext ?? 'N/A'); ?>
        ...
        <td>
          <button class="btn btn-sm btn-warning"
                  data-toggle="modal"
                  data-target="#sign_up_contact_support_modal">
            <i class="fa fa-edit"></i>
          </button>
        </td>
      </tr>
...
<div class="modal fade" id="sign_up_contact_support_modal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <form action="<?php echo e(route('signup.contact.support.update', 27)); ?>" method="POST">
        <?php echo csrf_field(); ?>

        <div class="modal-header bg-success text-white">
          <h5 class="modal-title">Update Signup Whatsapp Number</h5>
          <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
        </div>

        <div class="modal-body">
          <input type="text"
                 name="sign_up_contact_support"
                 class="form-control form-control-lg"
                 value="<?php echo e($signup_contact_support->longtext ?? ''); ?>"
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/Newprojectadmin.codescarts.com/resources/views/work_order_assign/support_setting.blade.php ENDPATH**/ ?>