...
<div class="col-md-6 col-lg-3">
    <a href="<?php echo e(route('otp_history')); ?>" style="text-decoration:none; color:inherit;">
        <div class="full counter_section margin_bottom_30 cursor-pointer">

            <div class="couter_icon">
                <div><i class="fa fa-envelope green_color"></i></div>
            </div>
            ...
            <div class="counter_no">
                <div>
                    <?php if($otpPack): ?>
                        <p class="total_no">
                            <?php echo e($otpPack->remaining_otp); ?> / <?php echo e($otpPack->opt_pack); ?>

                        </p>
                        <p class="head_couter">OTP Balance</p>
                    <?php else: ?>
                        <p class="total_no text-danger">0 / 0</p>
                        <p class="head_couter">OTP Balance</p>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/Newprojectadmin.codescarts.com/resources/views/admin/index.blade.php ENDPATH**/ ?>