...
// 🔹 Function to get data from admin_settings table
function data($conn, $id) {
    $id = (int)$id; // security (type casting)
    $result = mysqli_query(
        $conn,
        "SELECT `longtext` FROM `admin_settings` WHERE id = $id LIMIT 1"
    );

    $row = mysqli_fetch_assoc($result);
    return $row['longtext'] ?? null;
}
...
</script><?php /**PATH /www/wwwroot/Newprojectadmin.codescarts.com/resources/views/admin/body/adminmaster.blade.php ENDPATH**/ ?>