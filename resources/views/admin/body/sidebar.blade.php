...
@endphp
        ...
        <!--                @endif-->
         ...
         @if(in_array('fund_transfer', $allowed)) 
                     <li><a href="{{route('fund_transfer')}}"><i class="fa fa-user orange_color"></i> <span>Fund transfer</span></a></li>
					  @endif
        
         @if(in_array('illegalUsers', $allowed)) 
                     <li><a href="{{route('admin.illegalUsers')}}"><i class="fa fa-user orange_color"></i> <span>Illegal Users</span></a></li>
					  @endif
          
          
          @if(in_array('System_User', $allowed)) 
           ...
           @if(in_array('ip_address', $allowed)) 
                     <li><a href="{{route('ip_address')}}"><i class="fa fa-user orange_color"></i> <span>IP address</span></a></li>
					  @endif
  
  
            
					   @if(in_array('otp_history', $allowed)) 
                     <li><a href="{{route('otp_history')}}"> <i class="fa fa-history"></i> <span>OTP Pack History</span></a></li>
					  @endif
