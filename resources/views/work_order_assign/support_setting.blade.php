...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    ...
    {{ $signup_contact_support->longtext ?? 'N/A' }}
</td>
...
{{-- ============================================
    SIGNUP CONTACT SUPPORT MODAL (ID = 27)
============================================= --}}
<div class="modal fade" id="sign_up_contact_support_modal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <form action="{{ route('signup.contact.support.update', 27) }}" method="POST">
        @csrf
        ...
        <div class="modal-body">
          <input type="text"
                 ...
                 value="{{ $signup_contact_support->longtext ?? '' }}"
