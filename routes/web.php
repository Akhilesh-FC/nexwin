...
Route::post('/admin/send-notification', [AdminNotificationController::class, 'sendNotification'])
    ...
    Route::post('/paymode_show/toggle-status/{id}',[UserController::class, 'paymode_toggleStatus'])->name('paymode_show.toggleStatus');
    ...
    Route::post('/campaign/update-revenue',[UserController::class, 'updateUserCampaignRevenue'])->name('campaign.update.revenue');
...
Route::post('/need-help/chat/update/{id}', [SettingController::class, 'Need_Help_Chat_With_Us'])
  ...
  // View
Route::get('/sign_up/chat/{id}',
    [SettingController::class, 'signup_contact_support_view']
)->name('sign_up_contact_support.chat.view');

Route::post(
    '/signup-contact-support/update/{id}',
    [SettingController::class, 'signup_contact_support']
)->name('signup.contact.support.update');


// Update
Route::post('/sign_up_contact_support/chat/update/{id}',
    [SettingController::class, 'sign_up_contact_support']
)->name('sign_up_contact_support.chat.update');
